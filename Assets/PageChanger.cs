...
public class PageChanger : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string Page4 = "Wall Phase\nWalls can be placed on the edges between tiles to block off the path of other players.  However, walls may not be played on the edge of a starting tile.  During the wall phase, you may choose to perform one of three options: \nPlace one of your walls. To place a wall, click one of your unplaced walls.  Then, click the “Move Wall” button on the bottom right corner of the screen.  Finally, click where you would like to place the wall.\nMove one of your walls. To move a wall, click one of your placed walls. Then, click the “Move Wall” button on the bottom right corner of the screen. Finally, click where you would like to move the wall.\nRemove an opponent’s wall. To remove a wall, select a wall by clicking on it, and then click on the “Remove Wall” button at the bottom right corner of the screen.\n";
        string Page5 = "Rotate Phase\nThe second part of your turn allows you to rotate a number of hex tiles.  To rotate a tile, click on the tile you wish to rotate, and then click on either of the rotation buttons in the bottom right corner of the screen.  A single rotation turns a tile 60°, but a tile can be rotated more than once per turn.  The number of tiles you can rotate is up to the current number of walls your opponents have in total / 2 rounded up.  Your remaining rotations are indicated by a counter at the top left of the screen.  Once you are done rotating or your amount of rotations reaches 0, you can proceed to the next phase by clicking the Next Phase button.";
        string Page6 = "Move Phase\nThe move phase is when you get to move your player pawn.  Tiles are considered Valid Tiles if they have connected paths and are not separated by a wall.  To move, click on a Valid Tile that is adjacent to your pawn, then click the Move button.  Players cannot move onto the tile that another player is on. You can move a number of hexes up to the number of walls that you currently have on the board.  Your remaining movement is indicated at the top left corner of the screen.  You may end the move phase before you use up all your movement by clicking the Next Phase Button.";
